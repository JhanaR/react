...
function shuffleCards(){
    for(let i=cardsArray.length-1;i>=0;i--){//Array to shuffle from last card
        const randIndex = Math.floor(Math.random()*(i+1));//just random generating
        [cardsArray[i],cardsArray[randIndex]] = [cardsArray[randIndex],cardsArray[i]]//swapping of array
    }
}
